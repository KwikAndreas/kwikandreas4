// components/sections/AboutOptimized.tsx
"use client";
...
// Simple animation variants to prevent infinite loops
                ...
                {activeTab === "story" && (
                  <div className="space-y-6">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      I started my journey in technology during high school,
                      where I discovered my passion for creating digital
                      solutions. What began as curiosity about how websites work
                      evolved into a deep love for full-stack development.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
