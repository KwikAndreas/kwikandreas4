...
export default function ProjectDetailPage({ params }: ProjectDetailPageProps) {
  ...
  const structuredData = {
    ...
    image: `https://kwikandreas.vercel.app${project.image}`,
    author: {
      "@type": "Person",
      name: "Andreas",
    ...
    dateCreated: project.stats.completionDate,
    ...
    workExample: project.liveLink
      ...
      : undefined,
    codeRepository: project.githubLink !== "#" ? project.githubLink : undefined,
  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        <title>{project.title} - Project Details | KwikAndreas</title>
        <meta name="description" content={project.fullDescription} />
        <meta
          name="keywords"
          content={`${project.technologies.join(
            ", "
          )}, ${project.category.toLowerCase()}, portfolio project`}
        />
        <meta
          property="og:title"
          content={`${project.title} - Project Details`}
        />
        <meta property="og:description" content={project.fullDescription} />
        <meta
          property="og:image"
          content={`https://kwikandreas.vercel.app${project.image}`}
        />
        <meta
          property="og:url"
          content={`https://kwikandreas.vercel.app/projects/${project.id}`}
        />
        <meta property="og:type" content="article" />
        <link
          rel="canonical"
          href={`https://kwikandreas.vercel.app/projects/${project.id}`}
        />
        <script
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-12 pt-16">
